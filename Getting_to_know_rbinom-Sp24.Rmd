...
2) How would you adjust the code above to simulate ten flips of a single coin? (10 separate observations of one coin)
...
3) How about one draw of ten coins? (10 coins tossed simultaneously, observed once)
...
4) How about ten draws with each having 10 coins? (10 coins tossed simultaneously, observed 10 separate times)
