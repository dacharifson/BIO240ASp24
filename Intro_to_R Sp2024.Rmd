...
We will be working with a dataset called "present", which includes the number of individuals assigned a gender of boy or girl at birth in the United States from 1940-2002.
...
We can easily create and name/assign new variables in R.  For example, let's make the variables A and B and save their sum as S.
...
We can also do this with vectors of numbers.  A vector in R is a sequence of data values or items. Note that R requires that vectors be identified using the c() notation.
